...
//====list /pastes route handle (GET /pastes) 
...
function bodyDataHas(propertyName) {
  ...
  function expirationIsValidNumber(req, res, next){
    ...
    if (expiration <= 0 || !Number.isInteger(expiration)){          return next({
            status: 400,
...
//======== create-paste handler (POST /pastes) 
...
//=============== read-paste handler (GET /pastes/:pasteId)===============
...
//=========update-paste handler (PUT /paste/:pasteId)===========================
function update(req, res) {
    ...
    // res.json({ data: foundPaste });
    // }
//===delete-paste handler  (DELETE /paste/:pasteId)==============
...
//module.exports = {create: [bodyHasTextProperty, create],list,};
